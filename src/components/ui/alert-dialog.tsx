...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      className={cn(
        // pointer-events-auto: vaul sets body pointer-events:none while a modal
        // Drawer is open, which this portal-to-body element would otherwise inherit,
        // making it visible but click-through to the Drawer beneath it.
